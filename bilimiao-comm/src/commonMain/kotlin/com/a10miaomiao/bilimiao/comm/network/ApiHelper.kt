 ...
 */
// EN: Created by 10miaomiao on 2017/4/9
object ApiHelper {
    ...
    // EN: After logging in with which APP_KEY, subsequent requests must use the same APP_KEY. Now unified to use HD version. APP version APP_KEY cannot use QR code login
    // Android APP
