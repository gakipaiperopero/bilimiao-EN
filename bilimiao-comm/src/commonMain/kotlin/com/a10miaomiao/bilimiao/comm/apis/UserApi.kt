...
class UserApi {
     ...
     * 获取up主的视频投稿
     */
    // EN: Get uploader's video submissions
    fun upperVideoList(
        vmid: String,
        aid: String,
        pageSize: Int,
    ...
    fun medialistResourceList(
        ...
        // EN: 5 is series, 8 is seasons, others unknown
        oid: String,
    ) = MiaoHttp.request {
     ...
     * 清除稍后再看视频
     */
    // EN: Clear watch later videos
    fun videoToviewClean(
        cleanType: Int, // 1:已失效, 2:已看完
        // EN: 1: expired, 2: watched
    ) = MiaoHttp.request {
