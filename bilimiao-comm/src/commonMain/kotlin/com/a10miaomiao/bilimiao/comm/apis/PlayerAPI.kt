...
class PlayerAPI {
     ...
     */
    // EN: Get video play URL. fnval: 976:flv, 1:mp4, 4048:dash
    suspend fun getVideoPalyUrl(
        ...
        val params = mutableMapOf<String, String?>(
            ...
            // EN: Force audio/video to return https
            "type" to "",
            "otype" to "json",
        )
        if (fnval > 2) {
    ...
    suspend fun getProxyBangumiUrl(
        ...
        val res = MiaoHttp.request {
            if (proxyServer.enableAdvanced == true) {
                // 启用高级设置，自定义请求参数和请求头
                // EN: Enable advanced settings, custom request params and headers
...
//                params["area"] = "hk"
    ...
    fun sendDamaku(
        ...
        // EN: 1: normal, 4: bottom, 5: top, 7: advanced, 9: BAS (pool must be 2)
    ) = MiaoHttp.request {
        url = BiliApiService.biliApi(
            "x/v2/dm/post"
        )
