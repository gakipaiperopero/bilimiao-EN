...
//    }
     ...
     * 密码登录带验证码
     */
    // EN: Password login with captcha
    fun oauth2Login(
        username: String,
        passport: String,
        key: String,
     ...
     * 手机号验证登录
     */
    // EN: Phone number verification login
    fun telVerify(
        code: String,
        tmpCode: String,
        requestId: String,
     ...
     * 邮箱验证码发送
     */
    // EN: Email verification code send
    fun emailSend(
        tmpCode: String,
        geeChallenge: String,
        geeSeccode: String,
     ...
     * 短信验证码登录
     */
    // EN: SMS verification code login
    fun smsLogin(
        cid: String, // 国际区号
        // EN: International dialing code
        tel: String ,
        code: String ,
        captchaKey: String ,
        key: String,
