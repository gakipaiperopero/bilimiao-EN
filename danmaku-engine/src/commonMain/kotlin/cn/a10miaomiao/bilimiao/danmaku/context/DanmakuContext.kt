 ...
 */
// EN: Danmaku context, holds all display and filter configurations
class DanmakuContext {
     ...
     * 配置变更回调接口
     */
    // EN: Config change callback interface
     ...
     * 弹幕显示隐藏设置
     */
    // EN: Danmaku visibility settings
     ...
     */
    // EN: On-screen count: -1=auto, 0=unlimited, n=max n
    var maximumNumsInScreen: Int = -1

    /**
     * 默认滚动速度系数
     */
    // EN: Default scroll speed factor
     ...
     */
    // EN: Displayer (provided via DI, not created directly)
     ...
     */
     // EN: 0 Default Choreographer-driven DrawHandler thread refresh. 1 "DFM Update" separate thread refresh. 2 DrawHandler thread self-driven refresh
     ...
     * 设置是否显示顶部弹幕
     */
    // EN: Set whether to show top danmaku
     ...
     * 设置是否显示底部弹幕
     */
    // EN: Set whether to show bottom danmaku
     ...
     * 设置是否显示左右滚动弹幕
     */
    // EN: Set whether to show L2R scrolling danmaku
     ...
     * 设置是否显示右左滚动弹幕
     */
    // EN: Set whether to show R2L scrolling danmaku
     ...
     * 设置是否显示特殊弹幕
     */
    // EN: Set whether to show special danmaku
     ...
     * @param maxSize 最大数量
     */
     // EN: Set on-screen danmaku density: -1 auto, 0 unlimited
     ...
     * @param bold 是否粗体
     */
     // EN: Set whether to display bold, ineffective for some fonts
     ...
     * @param colors 颜色值数组
     */
     // EN: Set color filter danmaku whitelist
     ...
     */
     // EN: Set blocked danmaku user hash
     ...
     * @param ids 用户id数组
     */
     // EN: Set blocked danmaku user id, 0 means guest danmaku
     ...
     */
     // EN: Set whether to block guest danmaku
     ...
     * @param p 速度系数
     */
     // EN: Set danmaku scroll speed factor, only effective for scrolling danmaku
     ...
     * @param enable 是否启用
     */
     // EN: Set whether to enable duplicate danmaku merging
     ...
     * @param enable 是否启用
     */
     // EN: Set danmaku bottom alignment
     ...
     *        V = true|false 是否重叠
     */
     // EN: Set anti-danmaku overlapping. true|false whether to overlap
