...
open class DanmakuFactory protected constructor() {
     ...
     * @return 弹幕实例
     */
     // EN: Create danmaku data (using last saved config)
     ...
     * @return 弹幕实例
     */
     // EN: Use this method when creating danmaku data, refer to BiliDanmakuParser or AcfunDanmakuParser
     ...
     * 更新最大弹幕存活时间
     */
    // EN: Update max danmaku duration
     ...
     * @param f 速度因子
     */
     // EN: Update scrolling danmaku duration factor
     ...
     */
     // EN: Initialize special danmaku translation data
     ...
     * @param points 路径点数组
     */
     // EN: Initialize special danmaku path data
     ...
     */
     // EN: Initialize special danmaku alpha data
