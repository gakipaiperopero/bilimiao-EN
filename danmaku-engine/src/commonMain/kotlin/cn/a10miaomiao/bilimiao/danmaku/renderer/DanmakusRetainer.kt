 ...
 */
// EN: Danmaku position manager; assigns positions to avoid collisions
class DanmakusRetainer(alignBottom: Boolean) {

    /**
     * 弹幕位置管理器接口
     */
    // EN: Danmaku position manager interface
     ...
     * 校验器接口，用于二次过滤
     */
    // EN: Verifier interface for secondary filtering
     ...
     * 从上到下排列弹幕，找到不碰撞的位置
     */
     // EN: Top-aligned position manager. Arrange from top to bottom, find non-colliding positions
     ...
     */
     // EN: Top fixed danmaku position manager. Extends AlignTopRetainer, only checks bottom boundary
     ...
     * 从下到上排列弹幕
     */
     // EN: Bottom-aligned position manager. Arrange from bottom to top
