...
abstract class BaseDanmaku {
    ...
    /** 库内部使用的临时引用 */
    // EN: Internal library temp reference
    @JvmField var obj: Any? = null

    /** 外部自定义数据引用 */
    // EN: External custom data reference
    ...
    /** 阴影/描边颜色 */
    // EN: Shadow/stroke color
    @JvmField var textShadowColor: Int = 0

    /** 下划线颜色, 0表示无下划线 */
    // EN: Underline color (0=none)
    ...
    // EN: Priority: 0=low (filtered), >0=high (not filtered)
