...
import app.bilimiao.desktop.window.WindowUtils
...
fun main() {
    val appIcon = object {}.javaClass.getResourceAsStream("/bilimiao.ico")
        ?.use { it.readAllBytes() }
        ?.let { BitmapPainter(Image.makeFromEncoded(it).toComposeImageBitmap()) }

    // VLC native libraries loaded automatically via vlcj JNA
                                ...
                                playerContent = {
                                    DesktopPlayerContainer(
                                        ...
                                        onFullscreenToggle = {
                                            ...
                                            scope.launch {
                                                WindowUtils.instance.setUndecoratedFullscreen(
