 ...
 * 默认的弹出预览时的动画效果
 */
// EN: Default popup preview enter animation effect
 ...
 * 默认的关闭预览时的动画效果
 */
// EN: Default popup preview exit animation effect
 ...
 */
// EN: Way to get a PopupPreviewerState
// EN: Total page count
@Composable
 ...
 */
// EN: Popup preview state and control object
// EN: Encapsulated generic pagerState
open class PopupPreviewerState(
    ...
    // 是否可见的目标值
    // EN: Target visible value
    var visibleTarget by mutableStateOf<Boolean?>(null)
        internal set

    // 是否允许执行open操作
    // EN: Whether open operation is allowed
    val canOpen: Boolean
        get() = !visible && visibleTarget == null && !animating

    // 是否允许执行close操作
    // EN: Whether close operation is allowed
     ...
     */
    // EN: Update current marker state
    ...
    open suspend fun openAction(
        ...
        // 设置当前转换动画
        // EN: Set current transition animation
        this.enterTransition = enterTransition
        // container动画立即设置为关闭
        // EN: Container animation immediately set to closed
        animateContainerVisibleState = MutableTransitionState(false)
        // 开启container
        // EN: Open container
        animateContainerVisibleState.targetState = true
        // 滚动到指定页面
        // EN: Scroll to specified page
        scrollToPage(index)
        // 等状态变到目标值
        // EN: Wait for state to change to target value
    ...
    suspend fun open(
        ...
        stateOpenStart()
        // 实际业务发生
        // EN: Actual business logic occurs
    ...
    open suspend fun closeAction(
        ...
        // EN: Create a brand new state here so exitTransition setting takes effect
        animateContainerVisibleState = MutableTransitionState(true)
        // 开启container关闭动画
        // EN: Start container close animation
 ...
 */
// EN: Popup preview component based on Pager and ZoomableView
// EN: Layer modifier
// EN: Component state and control object
// EN: Item spacing
// EN: Beyond viewport cache count
// EN: Enter animation
// EN: Exit animation
// EN: Gesture detection
// EN: Outer layer container modifier
// EN: ZoomableView layer modifier
@Composable
fun PopupPreviewer(
        ...
        AnimatedVisibility(
            ...
            previewerDecoration {
                ZoomablePager(
                    ...
                    // 正在动画中不允许页面滚动
                    // EN: Page scrolling not allowed during animation
