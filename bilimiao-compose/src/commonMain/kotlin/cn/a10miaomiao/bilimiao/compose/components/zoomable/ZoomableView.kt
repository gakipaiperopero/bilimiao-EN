 ...
 */
// EN: ZoomableView gesture object
// EN: Tap event
// EN: Double tap event
// EN: Long press event
 ...
 */
// EN: Component supporting gesture zoom on Composable
// EN: Layer modifier
// EN: Whether to clip display bounds
// EN: ZoomableView state and control object
// EN: Component gesture callback
// EN: Display content for gesture zoom
@Composable
fun ZoomableView(
    ...
    state.apply {
        BoxWithConstraints(
            ...
            // EN: Ensure filling outer container size when container size is not specified
            density.apply {
                updateContainerSize(
                    Size(
                        width = maxWidth.toPx(),
 ...
 * @return 是否到底边缘
 */
// EN: Check if gesture movement has reached the edge
// EN: Whether reached the edge
 ...
 * 判断位移是否在边界内
 */
// EN: Check if offset is within bounds
 ...
 * @return Float
 */
// EN: Make the sign of the second number consistent with the first
 ...
 * 重写事件监听方法
 */
// EN: Override event listener method
