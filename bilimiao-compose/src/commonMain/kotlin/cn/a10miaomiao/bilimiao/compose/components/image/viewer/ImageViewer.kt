 ...
 */
// EN: Single image preview component
// EN: Layer modifier
// EN: Image to display, default supports Painter, ImageBitmap, ImageVector, AnyComposable; customize processor for other types
// EN: Component state and control class
// EN: Render model data to the UI
// EN: Detect component gesture interaction
@Composable
fun ImageViewer(
 ...
 */
// EN: Method for parsing image data for ZoomableView display
 ...
 * @return
 */
// EN: Check if object is a subclass of a class
// EN: Current instance
// EN: Class object to match
 ...
 * @property composable
 */
// EN: ImageViewer Model parameter also supports a Composable function in addition to specific image types
