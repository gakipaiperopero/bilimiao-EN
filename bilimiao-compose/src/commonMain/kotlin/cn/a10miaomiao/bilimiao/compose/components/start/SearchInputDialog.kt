                ...
                Column(
                    ...
                    Row(
                        ...
                        FilterChip(
                            selected = mode == 1,
                            onClick = { mode = 1 },
                            label = { Text(selfSearchName ?: "Current page") }
                        )
...
//                        }
    ...
    pendingDelete?.let { value ->
        AlertDialog(
            ...
            title = { Text("Confirm delete, meow~") },
            text = { Text("Search history keyword will be deleted") },
            confirmButton = {
                TextButton(onClick = {
            ...
            dismissButton = {
                Row(horizontalArrangement = Arrangement.spacedBy(8.dp)) {
                    TextButton(onClick = { showClearAll = true; pendingDelete = null }) { Text("Clear all") }
