 ...
 * @param pagerState
 */
// EN: For controlling transition effect and image list browsing layers
// EN: Coroutine scope
    ...
    private suspend fun enterTransformInternal(
        ...
        if (itemState != null) {
            itemState.apply {
                ...
                // 设置动画开始的位置
                // EN: Set animation start position
...
//                val animationSpec = tween<Float>(600)f
                ...
                // 等待挂载成功
                // EN: Wait for mount success
                if (alreadyScroll2Current) awaitMounted()
                // 动画结束，开启预览
                // EN: Animation ends, enable preview
...
//                stateOpenEnd()
    ...
    suspend fun exitTransform(animationSpec: AnimationSpec<Float>? = null) {
        ...
        // 获取当前页码
        // EN: Get current page number
        val index = currentPage
        // 同步动画开始的位置
        // EN: Sync animation start position
        val itemState = findTransformItemByIndex(index)
 ...
 * @return 返回显示的大小
 */
// EN: Get the size of a component when fully displayed in the container
// EN: Component intrinsic size
// EN: Container size
// EN: Return display size
 ...
 */
// EN: Transition effect layer during transformation
// EN: For controlling transition effect and image list browsing layers
// EN: Debug mode
@Composable
 ...
 */
// EN: Placeholder layer before switching to actual display layer during transition
// EN: Current page number
// EN: Layer control object
// EN: Whether in debug mode
@Composable
 ...
 */
// EN: Customize preview layer through this object
// EN: Layer modifier
// EN: Background layer
// EN: Foreground layer
 ...
 */
// EN: Image preview component supporting popup transition animation
// EN: Layer modifier
// EN: State object
// EN: Item spacing
...
//                                delay(1000)
                        ...
                        // EN: If waiting for mount takes too long due to rapid page switching, the opened page is removed
 ...
 */
// EN: Small image container for implementing Previewer transition effect
// EN: Layer modifier
// EN: Unique identifier
// EN: State and control object for this component
// EN: Component state and control object
// EN: Actual content to display
@Composable
