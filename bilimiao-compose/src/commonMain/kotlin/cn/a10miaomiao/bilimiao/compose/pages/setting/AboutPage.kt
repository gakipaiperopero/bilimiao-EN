...
private class AboutPageViewModel(
    ...
    fun checkUpdate() = viewModelScope.launch(Dispatchers.IO) {
        try {
            ...
            e.printStackTrace()
            GlobalToaster.show("Network error, update check failed")
            versionState.value = AppVersionState.Fail(
...
private const val WARN_TEXT = """1. This app is a third-party client for Bilibili. All resources come from bilibili.com
2. If your rights are infringed, please contact me for immediate removal"""
                ...
                when (versionState) {
                    ...
                    is AppVersionState.HasUpdate -> {
                        TextButton(
                            ...
                            Text(text = "New version: " + versionState.version)
                        }
                    }
                    is AppVersionState.Fail -> {
                        TextButton(
                            ...
                            Text(text = "Update check failed")
                        }
                    }
                }
                Text(
                    text = "Current version: " + viewModel.versionName,
