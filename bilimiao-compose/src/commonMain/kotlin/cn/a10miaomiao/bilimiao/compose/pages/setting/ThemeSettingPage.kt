...
private class ThemeSettingPageViewModel(
    ...
    val colorList = listOf<Pair<Long, String>>(
        0xFFFB7299 to "Sakura Pink",
        0xFF2196F3 to "Panties Blue",
        0xFFFDD835 to "Egg Yolk",
        0xFFFF9800 to "Cat Orange",
        0xFF673AB7 to "Vibrant Purple",
        0xFF4CAF50 to "Sanae Green",
        0xFFF44336 to "Mai Red",
        0xFF39C5BB to "Miku Green",
        0xFF66CCFF to "Tianyi Blue",
