...
class TypeBangumiContentViewModel(
    ...
    val typeName = if (type == "cinema") "Drama" else "Anime"
    ...
    fun changeFollowStatus(
        ...
        try {
            ...
            if (res.isSuccess) {
                ...
                if (status == 0) {
                    GlobalToaster.show("Unfollowed $typeName")
                } else {
            ...
            e.printStackTrace()
            GlobalToaster.show("Operation failed: " + (e.message ?: e.toString()))
        }
...
fun TypeBangumiContent(
    ...
    Column(
        ...
        val moreMenu = remember(currentStatus) {
            if (currentStatus == 0) {
                listOf(0 to "Unfollow ${viewModel.typeName}")
            } else {
                listOf(
                    Pair(0,"Unfollow ${viewModel.typeName}"),
                    Pair(1, "Mark as 'Want to watch'").takeIf {
                        currentStatus != 1
                    },
                    Pair(2, "Mark as 'Watching'").takeIf {
                        currentStatus != 2
                    },
                    Pair(3, "Mark as 'Watched'").takeIf {
                        currentStatus != 3
                    },
                )
            }
