...
//    var recaptchaToken = ""
    ...
    private val gt3Listener = object : GT3Listener() {
         ...
         */
        // EN: Verification code loading complete
        // EN: @param duration Load time and version info, in JSON format
         ...
         */
        // EN: Graphic verification result callback
        // EN: @param code 1 for success, 0 for failure
         ...
         */
        // EN: Custom api2 callback
        // EN: @param result, api2 request upload parameters
         ...
         * @param result
         */
        // EN: Statistics info, refer to integration documentation
         ...
         */
        // EN: Verification code closed
        // EN: @param num 1 click close button, 2 click screen, 3 press back key
         ...
         * @param result
         */
        // EN: Verification success callback
         ...
         */
        // EN: Verification failure callback
        // EN: @param errorBean Version, error code, error description, etc.
    ...
    // EN: Configure GT3ConfigBean, can also be set before calling startCustomFlow
    ...
    init {
        gt3ConfigBean.run {
            pattern = 1;
            // 设置点击灰色区域是否消失，默认不消息
            // EN: Set whether clicking gray area dismisses, default no dismiss
            isCanceledOnTouchOutside = false;
            // 设置语言，如果为null则使用系统默认语言
            // EN: Set language, null uses system default
            lang = null;
            // 设置加载webview超时时间，单位毫秒，默认10000，仅且webview加载静态文件超时，不包括之前的http请求
            // EN: Set webview load timeout in ms, default 10000, only for static file loading timeout, excluding http requests
            timeout = 10000;
            // 设置webview请求超时(用户点选或滑动完成，前端请求后端接口)，单位毫秒，默认10000
            // EN: Set webview request timeout (user click/slide, frontend requests backend), in ms, default 10000
