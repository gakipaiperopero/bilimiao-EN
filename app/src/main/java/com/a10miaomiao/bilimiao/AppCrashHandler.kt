 ...
 */
// EN: Reference: https://www.jianshu.com/p/0ea4615674f0
class AppCrashHandler private constructor(
    private val context: Context
) : Thread.UncaughtExceptionHandler {
    // 用于格式化日期
    // EN: Used for date formatting
     ...
     * 构造初始化
     */
    // EN: Constructor initialization
    init {
        // 设置当前类为应用默认处理器
        // EN: Set current class as default exception handler
     ...
     * @param e
     */
    // EN: Called when an UncaughtException occurs
    ...
    private fun handleException(e: Throwable) {
         ...
         * 比如保存崩溃日志到文件等等
         */
        // EN: Additional business operations can be performed here
        // EN: Such as saving crash logs to files, etc.
     ...
     * @param info
     */
    // EN: Collect parameter information
